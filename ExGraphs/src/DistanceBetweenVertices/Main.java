package DistanceBetweenVertices;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //direct path between two vertices of directed graph with no weight = BFS
        ...
        while (pairs-- > 0) {
            int[] relations = Arrays.stream(scanner.next().split("-"))
                    .mapToInt(Integer::parseInt)
                    .toArray();
            ...
            //index Mapper maps the indexes of the vertices
